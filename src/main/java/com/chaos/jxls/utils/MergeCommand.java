...
/**
 * Created by huangdawei on 2018/8/26.
 */
public class MergeCommand extends AbstractCommand {
    ...
    private String defaultCellStyleCell;
    ...
    protected Size poiMerge(CellRef cellRef, Context context, PoiTransformer transformer, int rows, int cols) {
        ...
        area.applyAt(cellRef, context);
        if (StringUtils.isNotBlank(defaultCellStyleCell)) {
            CellRef defaultStyleCellRef = new CellRef(defaultCellStyleCell);
            PoiCellData cellData = (PoiCellData) transformer.getCellData(defaultStyleCellRef);
    ...
    public String getDefaultCellStyleCell() {
        return defaultCellStyleCell;
    }

    public void setDefaultCellStyleCell(String defaultCellStyleCell) {
        this.defaultCellStyleCell = defaultCellStyleCell;
    }
}
